...
var transformProp = (_d = {}, _d[DIRECTION_VERTICAL] = 'translateY', _d[DIRECTION_HORIZONTAL] = 'translateX', _d);
var _a;
var _b;
var _c;
var _d;
...
var VirtualList = function (_super) {
    ...
    function VirtualList() {
        ...
        _this.getRootNodeRef = function (node) {
            _this.rootNode = node;
        };
        _this.getInnerNodeRef = function (node) {
    ...
    VirtualList.prototype.scrollTo = function (value, skipTransition) {
        var _this = this;
        ...
        var preScrollRect = this.innerNode.getBoundingClientRect();
        // Scroll to the right position
        this.rootNode[scrollProp[scrollDirection]] = value;
        // Return early and perform no animation if forced, or no transition has
        // been passed
        if (skipTransition || this.props.scrollToTransition === undefined || this.innerNode.style.transition !== '') {
            return;
        }
        // The rect of the element after being scrolled lets us calculate the
        // distance it has travelled
        var postScrollRect = this.innerNode.getBoundingClientRect();
        var delta = preScrollRect[positionProp[scrollDirection]] - postScrollRect[positionProp[scrollDirection]];
        ...
        requestAnimationFrame(function () {
            _this.innerNode.style.transition = _this.props.scrollToTransition || '';
            _this.innerNode.style.transitionProperty = 'transform';
            _this.innerNode.style.transform = '';
        });
        // We listen to the end of the transition in order to perform some cleanup
        var reset = function () {
            _this.innerNode.style.transition = '';
            _this.innerNode.style.transitionProperty = '';
            _this.innerNode.removeEventListener('transitionend', reset);
        };
    ...
    VirtualList.prototype.render = function () {
        var _a = this.props,
            ...
            scrollToTransition = _a.scrollToTransition,
            scrollOffset = _a.scrollOffset,
            scrollToIndex = _a.scrollToIndex,
            scrollToAlignment = _a.scrollToAlignment,
            style = _a.style,
            width = _a.width,
            props = __rest(_a, ["estimatedItemSize", "height", "overscanCount", "renderItem", "itemCount", "itemSize", "onItemsRendered", "onScroll", "scrollDirection", "scrollToTransition", "scrollOffset", "scrollToIndex", "scrollToAlignment", "style", "width"]);
        ...
        return React.createElement("div", __assign({ ref: this.getRootNodeRef }, props, { onScroll: this.handleScroll, style: __assign({}, STYLE_WRAPPER, style, { height: height, width: width }) }), React.createElement("div", { ref: this.getInnerNodeRef, style: __assign({}, STYLE_INNER, (_e = { willChange: scrollToTransition !== undefined ? 'transform' : null }, _e[sizeProp[scrollDirection]] = this.sizeAndPositionManager.getTotalSize(), _e)) }, items));
        var _e;
    };
