...
var VirtualList = function (_super) {
    ...
    VirtualList.prototype.render = function () {
        ...
        return createElement("div", __assign({ ref: this.getRootNodeRef }, props, { onScroll: this.handleScroll, style: __assign({}, STYLE_WRAPPER, style, { height: height, width: width }) }), createElement("div", { ref: this.getInnerNodeRef, style: __assign({}, STYLE_INNER, (_e = { willChange: scrollToTransition !== undefined ? 'transform' : null }, _e[sizeProp[scrollDirection]] = this.sizeAndPositionManager.getTotalSize(), _e)) }, items));
        var _e;
    };
